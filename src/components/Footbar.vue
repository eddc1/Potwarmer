  ...
  <div class="mx-8 py-10 text-center md:text-left">
    <div class="grid gap-16 md:grid-cols-3 lg:grid-cols-3">
      <div class="">
        ...
        <p>
          Willkommen auf unserer Webseite für Blumentopfheizungen! Hier finden Sie alle notwendigen Informationen und Bauanleitungen, um Ihre eigenen umweltfreundlichen Heizgeräte zu bauen.
        </p>
      </div>
      <div class="">
        <h6
      ...
      <div class="">
        ...
        <p class="mb-4 flex items-center justify-center md:justify-start">
          ...
          Bettina-Brentano-Weg 17, <br> Bad Oeynhausen, DE
        </p>
        <p class="mb-4 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"

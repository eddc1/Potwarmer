      ...
      <div data-grid="container" class="" aria-label="Navigation der Seiten">
         ...
         <div class="icons">
            <a href="#" data-cta="learn" data-clickname=""
               aria-label="Erfahre jetzt mehr über Blumentopf">
               <div>
                  <div>
                     <img class=""
            ...
            <a href="#" data-cta="learn" data-clickname="" aria-label="Kerzen kaufen">
               <div>
            ...
            <a href="#" data-cta="learn" data-clickname=""
               aria-label="Komplette Auswahl an ZUBEHÖR durchsuchen">
               <div>
                  <div class="flex justify-center">
            ...
            <a href="#" data-cta="learn" data-clickname=""
               aria-label="WIEDERGEBE von Videos">
               <div>
                  <div>
                     <img
